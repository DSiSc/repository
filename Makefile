...
help:
	@echo 'Management commands for DSiSc/blockchain:'
	@echo
	@echo 'Usage:'
...
build:
	@echo "building blockchain ${VERSION}"
	@echo "GOPATH=${GOPATH}"
	go build -v -ldflags "-X github.com/DSiSc/blockchain/version.GitCommit=${GIT_COMMIT}${GIT_DIRTY} -X github.com/DSiSc/blockchain/version.BuildDate=${BUILD_DATE}" ./...
